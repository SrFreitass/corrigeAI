        ...
        <div className="flex  gap-8">
          ...
          <div className="w-1/2 flex flex-col justify-between">
            <div className="flex flex-col justfiy-between gap-2">
              ...
              <h3 className="text-xl font-medium">Estatísticas</h3>
              <p>N° de caracteres: {characteresEssay.length}</p>
              <p>
                N° de paragráfos: {[...characteresEssay.matchAll(/\n/g)].length}
              </p>
              <p>
                N° de palavras: {[...characteresEssay.matchAll(/ /g)].length}
              </p>
              <p>
                Redações com nota alta costumam ter entre 1800 e 2800 caracteres
                (letras, sinais de pontuação, espaços em branco, etc). Textos
                muito curtos não abordam o tema, muitas vezes, com a
                profundidade necessária. Textos muito longos, por outro lado,
                podem ser um indicativo de que você não está sintetizando o seu
                pensamento de forma satisfatória. Também é importante atentar-se
                sempre aos tamanhos mínimo e máximo da redação exigidos pela
                banca avaliadora, geralmente estipulados em números de linhas.
              </p>
              <div className="flex gap-8">
                ...
                <div className="flex items-center gap-2">
                  <p>Fonte serifada?</p>
                  <Input type="checkbox" onChange={handleFontSerif} />
                </div>
              </div>
            </div>
            <Button className="text-white font-medium">Enviar redação</Button>
          </div>
        </div>
      </main>
    </div>
